# Generated by Django 4.2.20 on 2026-03-15 01:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(default='Main Area', max_length=100)),
                ('status', models.CharField(choices=[('available', 'Available'), ('occupied', 'Occupied'), ('deactivated', 'Deactivated')], default='available', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='locker_system.locker')),
